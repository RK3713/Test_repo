...
import com.template.schema.TitleSchema;
import com.template.schema.TitleSchemaV1;
...
public class TitleState implements LinearState, QueryableState {
     ...
     */
    public TitleState(Integer value,
                    Party lender,
                    Party borrower,
    ...
    @Override public PersistentState generateMappedObject(MappedSchema schema) {
        if (schema instanceof TitleSchemaV1) {
            return new TitleSchemaV1.PersistentIOU(
    ...
    @Override public Iterable<MappedSchema> supportedSchemas() {
        return Arrays.asList(new TitleSchemaV1());
    }
