...
public class TemplateFlow {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            TitleState iouState = new TitleState(iouValue, me, otherParty, new UniqueIdentifier());
            final Command<TitleContract.Commands.Create> txCommand = new Command<>(
                    new TitleContract.Commands.Create(),
                    Arrays.asList(iouState.getLender().getOwningKey(), iouState.getBorrower().getOwningKey()));
            final TransactionBuilder txBuilder = new TransactionBuilder(notary)
                    .addOutputState(iouState, TitleContract.ID)
            ...
            class SignTxFlow extends SignTransactionFlow {
                ...
                protected void checkTransaction(SignedTransaction stx) {
                    requireThat(require -> {
                        ...
                        require.using("This must be an IOU transaction.", output instanceof TitleState);
                        TitleState iou = (TitleState) output;
